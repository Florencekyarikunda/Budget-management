...
def products(request):
	...
	return render(request, 'web_app/product.html', {'products':products})
...
def createOrder(request, pk):
	...
	return render(request, 'web_app/order_form.html', context)
...
def deleteOrder(request, pk):
	...
	context = {'item':order}
	return render(request, 'web_app/delete.html', context)